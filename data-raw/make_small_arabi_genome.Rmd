...
download.file(
  ...
  destfile = "data-raw/Arabidopsis_thaliana.TAIR10.dna.toplevel.fa.gz"
)

# Unzip
R.utils::gunzip(
  filename = "data-raw/Arabidopsis_thaliana.TAIR10.dna.toplevel.fa.gz",
  destname = "data-raw/Arabidopsis_thaliana.TAIR10.dna.toplevel.fasta"
)

# Read in fasta
arabidopsis_genome <- ape::read.FASTA("data-raw/Arabidopsis_thaliana.TAIR10.dna.toplevel.fasta")
...
ape::write.FASTA(
  arabidopsis_genome,
  "inst/extdata/Arabidopsis_thaliana_TAIR10_40_small.fasta")
